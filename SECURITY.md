...
NukeIt takes the security of our users and the integrity of this open-source
project very seriously.

## Reporting Security Vulnerabilities

If you believe you have discovered a security vulnerability in NukeIt, we
...
1. Navigate to the [NukeIt repository](https://github.com/ajaykumarn3000/nukeit)
...
- **Keep dependencies updated**: Regularly update NukeIt and its dependencies
- **Review generated code**: Always review the code scaffolded by NukeIt
...
- Projects generated with custom tools not provided by NukeIt

## Thank You

Thank you for helping us keep NukeIt and its community safe. We appreciate your
